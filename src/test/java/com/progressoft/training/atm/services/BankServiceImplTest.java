...
//        Mockito.when(bankRepository.getUserBalance("12345")).thenReturn(balance);
//
//        BankServiceImpl bankService = new BankServiceImpl(bankRepository, transferLogFileRepository);
//
...
//
//        Mockito.when(bankRepository.getUserBalance(senderPin)).thenReturn(senderBalance);
//
...
//
//        Mockito.when(bankRepository.getUserBalance(senderPin)).thenReturn(senderBalance);
//        Mockito.when(bankRepository.getUserBalance(receiverPin)).thenReturn(receiverBalance);
//
//        TransferRequest transferRequest = new TransferRequest(amount,senderPin,receiverPin);
//        bankService.transfer(transferRequest);
//
//        Mockito.verify(bankRepository).updateUserBalance(senderPin, new BigDecimal("20"));
//        Mockito.verify(bankRepository).updateUserBalance(receiverPin, new BigDecimal("130"));
//    }
//
//}